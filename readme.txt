...
### Live chat 
Nerdcom Chat allows you to embed a free live chat module on your website and let site visitors chat with you. 
...
* Marketing live chat: create emails or phone number lists, synchronize WooCommerce. Details [here](https://nerdcom.chat/marketing).
* Automated chatbot: create powerful scenario with by connecting the Dialogflow chatbot. Details [here](https://nerdcom.chat/bot).
...
It's fast and it works great. The Nerdcom Chat administration area is a progressive web app that can be installed on Windows and Macs. 
...
Register a new account at [https://app.nerdcom.chat](https://app.nerdcom.chat/).
...
From the WordPress admin area go to Settings > Nerdcom Chat and insert the embed code of the chat (get it from https://app.nerdcom.chat/account/).
Use the shortcode [sb-tickets] to display the ticket area. Use the shortcode [sb-articles] to display the articles area.

= What is Nerdcom Chat =

Nerdcom Chat provides a customer messaging platform for small and medium companies to help them scale their customers relationship. Live Chat and the chatbot are two of the main features but not the only ones. Give them a try!

= Who should use Nerdcom Chat? =

Nerdcom Chat is perfect for agencies, business owners, small businesses, bloggers, designers, anyone with a WordPress website and wants to use live chat on their website.

= Do I need coding skills to use Nerdcom Chat plugin? =
...
The Nerdcom Chat's paid tiers are built for those who send a large volume of messages. For more details, [view our pricing page](https://nerdcom.chat/).
