...
/*
 *
 * Plugin Name: NERDCOM CHAT
 * Plugin URI: https://app.nerdcom.chat/
 * Description: Smart chat for better support and marketing
 * Version: 1.0.1
 * Author: NERDCOM
 * Author URI: https://app.nerdcom.chat/
 * © 2022 nerdcom.chat. All rights reserved.
 *
 */

function sbcloud_set_admin_menu() {
    add_submenu_page('options-general.php', 'Nerdcom Chat', 'Nerdcom Chat', 'administrator', 'Nerdcom-Chat', 'sbcloud_admin');
}

function sbcloud_enqueue_admin() {
    if (key_exists('page', $_GET) && $_GET['page'] == 'Nerdcom-Chat') {
...
function sbcloud_enqueue() {
    ...
    wp_enqueue_script('chat-init', 'https://app.nerdcom.chat/account/js/init.js?id=' . esc_html($settings['chat-id']) . $language, ['jquery'], '1.0');
            ...
            <tbody>
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <br />
                        <p class="description">Insert the embed code. Get it from <a target="_blank" href="https://app.nerdcom.chat/account/?tab=installation">here</a>. Pricing <a target="_blank" href="https://app.nerdcom.chat/wordpress">here</a>.</p>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row">
                    ...
                    <td>
                        ...
                        <p class="description">
                            ...
                            This setting requires a WordPress Multisite installation and Nerdcom Chat departments with the same IDs of the WordPress websites.
                        </p>
                    </td>
                </tr>
                <tr valign="top">
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <br />
                        <p class="description">
                          Sync logged in WordPress users with Nerdcom Chat.
                        </p>
                    </td>
                </tr>
                <tr valign="top">
